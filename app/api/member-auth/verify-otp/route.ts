...
export async function POST(req: NextRequest) {
  ...
  if (!valid) {
    ...
    await recordAuthEvent(supabase, { portal: "member", eventType: "otp_verify_failed", phone, success: false, request: req });
  ...
  await recordAuthEvent(supabase, { portal: "member", eventType: "login_succeeded", phone, success: true, request: req });
